                ...
                <div className="container py-5">
                    <div className="row h-100 align-items-center py-5">
                        <div className="col-lg-6">
                            ...
                            <p className="lead text-muted">Snippet by <NavLink to="https://bootstrapious.com/snippets" className="text-muted">
                                <u>Bootstrapious</u></NavLink>
                            </p>
                        </div>
                        ...
                        <div className="col-xl-3 col-sm-6 mb-5">
                            <div className="bg-white rounded shadow-sm py-5 px-4"><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-4.png" alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                                ...
                                <ul className="social mb-0 list-inline mt-3">
                                    <li className="list-inline-item"><NavLink to="#" className="social-link"><i className="fa fa-facebook-f"></i></NavLink></li>
                                    <li className="list-inline-item"><NavLink to="#" className="social-link"><i className="fa fa-twitter"></i></NavLink></li>
                                    <li className="list-inline-item"><NavLink to="#" className="social-link"><i className="fa fa-instagram"></i></NavLink></li>
                                    <li className="list-inline-item"><NavLink to="#" className="social-link"><i className="fa fa-linkedin"></i></NavLink></li>
                                </ul>
                            </div>
                        </div>
